...
w1 = GameSprite('Wall.png',win_width / 2 - win_width / 3, win_height / 2, 300, 100)
w2 = GameSprite('Wall.png', 370, 100, 50, 300)
w3 = GameSprite('Wall.png', 340, 50, 80, 500)
...
w6 = GameSprite('Wall.png', 370, 100, 60, 400)
w7 = GameSprite('Wall.png',win_width / 4 - win_width / 8, win_height / 6, 300, 80)
w8 = GameSprite('Wall.png',win_width / 2 - win_width / 5, win_height / 4, 200, 70)
w9 = GameSprite('Wall.png', 400, 100, 10, 300)
